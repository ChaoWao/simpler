...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *inv_rms_tile_inline126__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *mlp_tile_inline149__iter_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *gate_acc_all_inline203__rv_v10_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *up_acc_all_inline303__rv_v10_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
