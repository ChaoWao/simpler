...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *mlp_norm_in_inline71__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *post_norm_partial_inline118__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
