...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *down_acc_all_inline168__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *gate_acc_all_inline203__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *up_acc_all_inline303__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *attn_proj_fp32_inline220__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
