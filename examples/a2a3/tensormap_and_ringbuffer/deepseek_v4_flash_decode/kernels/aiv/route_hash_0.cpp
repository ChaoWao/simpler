...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *tid2eid_l1_inline725__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *route_scores_buf_inline2607_inline10035__ssa_v1_tensor =
    ...
    __gm__ TaskTensor *indices_inline10048__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
