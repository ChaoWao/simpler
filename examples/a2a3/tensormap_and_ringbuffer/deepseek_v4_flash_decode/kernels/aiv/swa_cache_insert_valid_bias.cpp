...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *kv_cache_flat_inline9080__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *kv_inline9025__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *sparse_bias_inline9002__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[4]);
