...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *pre_val_store_inline14513__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *x_mixed_inline10524__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *x_flat_inline14530__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
