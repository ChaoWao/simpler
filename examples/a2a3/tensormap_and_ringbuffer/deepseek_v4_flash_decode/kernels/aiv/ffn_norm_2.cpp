...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *x_mixed_inline11928__rv_v2_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *norm_w_2d_inline2589_inline12095__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *x_norm_scale_inline11931__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[4]);
