...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *step_cos_il_inline12430__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *step_sin_signed_inline12365__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *pooled_kv_inline15274__rv_v2_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *normed_kv_inline15296__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
    ...
    __gm__ TaskTensor *norm_w_2d_inline15258__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[4]);
