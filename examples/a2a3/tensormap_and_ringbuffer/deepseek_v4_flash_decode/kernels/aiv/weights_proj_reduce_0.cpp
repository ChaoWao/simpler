...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *weights_partial_inline2014_inline12590__ssa_v1_tensor =
    ...
    __gm__ TaskTensor *weights_inline2015_inline12545__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
