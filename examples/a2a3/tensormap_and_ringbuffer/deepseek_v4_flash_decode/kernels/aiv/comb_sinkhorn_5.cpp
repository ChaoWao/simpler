...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *mixes_raw_inline14882__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *hc_base_2d_inline14919__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
