...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *cmp_cos_inline10566__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *cmp_sin_inline10337__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
