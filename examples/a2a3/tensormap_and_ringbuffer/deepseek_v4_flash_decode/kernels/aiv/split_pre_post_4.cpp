...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *inv_rms_inline14732__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *hc_ffn_base_csa_inline542__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *mixes_raw_inline14755__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *pre_val_store_inline14760__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
    ...
    __gm__ TaskTensor *post_ffn_inline11048__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[4]);
