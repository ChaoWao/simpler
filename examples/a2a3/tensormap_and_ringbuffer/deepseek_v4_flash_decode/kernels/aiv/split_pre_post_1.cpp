...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *inv_rms_inline14231__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *hc_attn_base_l1_inline675__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *mixes_raw_inline14254__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *pre_val_store_inline14259__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
    ...
    __gm__ TaskTensor *post_t_inline9709__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[4]);
