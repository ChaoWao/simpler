...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *hc_attn_base_last_inline509__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *mixes_raw_inline15136__ssa_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
    ...
    __gm__ TaskTensor *pre_val_store_inline15141__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[3]);
    ...
    __gm__ TaskTensor *post_t_inline12482__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[4]);
