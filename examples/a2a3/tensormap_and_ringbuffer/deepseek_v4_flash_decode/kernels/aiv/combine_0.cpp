...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *recv_meta_local_inline10167__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *recv_r_route_out_inline10131__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *recv_y_flat_inline2828_inline9902__ssa_v0_tensor =
