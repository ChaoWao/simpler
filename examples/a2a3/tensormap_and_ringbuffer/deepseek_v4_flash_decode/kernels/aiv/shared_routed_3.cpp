...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *sh_inline13063__rv_v2_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *routed_y_buf__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *ffn_out_inline12872__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
