...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *o_packed_inline2242_inline10294__ssa_v16_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *wo_a_csa_inline672__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *o_r_pad_inline2225_inline10832__iter_v1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
