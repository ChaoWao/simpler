...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *kv_partials_inline1803_inline10377__ssa_v0_tensor =
    ...
    __gm__ TaskTensor *wkv_csa_inline696__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
