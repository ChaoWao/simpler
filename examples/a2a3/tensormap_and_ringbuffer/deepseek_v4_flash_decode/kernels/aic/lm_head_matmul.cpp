...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *logits_shards_inline40_inline13289__ssa_v0_tensor =
    ...
    __gm__ TaskTensor *owner_hiddens_inline50_inline13292__ssa_v1_tensor =
    ...
    __gm__ TaskTensor *lm_head_weight__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
