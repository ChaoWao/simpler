...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *y_i32_inline2737_inline13010__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *h_tile_i8_inline2806_inline13011__ssa_v4_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    ...
    __gm__ TaskTensor *routed_w2_last_inline489__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
