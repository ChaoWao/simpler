...
# -----------------------------------------------------------------------------------------------------------
"""Pod ST for examples/workers/l4/vector_add_mixed_l3."""
...
def test_vector_add_mixed_l3(st_platform, st_device_ids, st_pod_peer, st_pod_remote_device_ids, st_pod_logs):
    rc = run(
