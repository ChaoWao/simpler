...
private:
    ...
    std::optional<std::vector<uint8_t>> poll_inbound(
...
public:
    MpiDirectTransport(
        std::shared_ptr<MpiDirectTransportHub> hub, int32_t worker_id, double attach_timeout_s,
