...
static_assert(
    offsetof(ChipTensor, child_memory) == 43, "child_memory must be at byte 43 (cacheline 1, former _pad_cl1)"
);
...
// consumers (the nanobind binding, make_tensor_arg) build ChipTensors through the
