...
| `st-sim-a2a3` | `ubuntu-latest`, `macos-latest` | `pytest examples tests/st -m "not pod" --platform a2a3sim` |
| `st-sim-a5` | `ubuntu-latest`, `macos-latest` | `pytest examples tests/st -m "not pod" --platform a5sim` |
