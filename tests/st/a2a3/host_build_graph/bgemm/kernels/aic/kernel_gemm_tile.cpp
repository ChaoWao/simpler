 ...
 */
/**
 * Tiled GEMM kernel (AIC, submit_task / TaskTensor* ABI)
 *
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *b_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
    __gm__ TaskTensor *p_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[2]);
