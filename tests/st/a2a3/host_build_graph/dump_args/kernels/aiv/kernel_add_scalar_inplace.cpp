 ...
 */
/**
 * In-place scalar addition kernel (submit_task / TaskTensor* ABI)
 *
 * Implements: inout[i] = inout[i] + scalar over a single 128x128 tile.
 *
 * Args:
 *   args[0] = inout (INOUT, TaskTensor*)
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    __gm__ TaskTensor *inout_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
