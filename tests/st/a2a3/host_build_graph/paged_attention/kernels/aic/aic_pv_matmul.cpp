...
static __aicore__ void pv_matmul_impl(__gm__ TaskTensor *pij, __gm__ TaskTensor *vj, __gm__ TaskTensor *oi) {
...
extern "C" __aicore__ void kernel_entry(__gm__ int64_t *args) {
    __gm__ TaskTensor *pij = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    __gm__ TaskTensor *vj = reinterpret_cast<__gm__ TaskTensor *>(args[1]);
