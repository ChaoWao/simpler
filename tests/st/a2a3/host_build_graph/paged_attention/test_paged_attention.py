    ...
    CASES = [
        {
            ...
            # exceeds the default ring window. Run it explicitly with a large
            # runtime_env.ring_task_window if needed; the GM heap needs no knob, since
            # it is committed to the size orchestration measured.
            "name": "Case1",
            "platforms": ["a2a3"],
            "manual": True,
            "params": {
