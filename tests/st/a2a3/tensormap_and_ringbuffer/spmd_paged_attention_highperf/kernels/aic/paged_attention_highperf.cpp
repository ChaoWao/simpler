...
extern "C" __aicore__ void kernel_entry(__gm__ int64_t *args) {
    ...
    return;
#else
    auto *query_t = reinterpret_cast<TaskTensor *>(args[0]);
    auto *key_t = reinterpret_cast<TaskTensor *>(args[1]);
    auto *value_t = reinterpret_cast<TaskTensor *>(args[2]);
    auto *block_table_t = reinterpret_cast<TaskTensor *>(args[3]);
    auto *out_t = reinterpret_cast<TaskTensor *>(args[4]);
...
static __aicore__ __attribute__((always_inline)) __gm__ uint8_t *tensor_data(__gm__ int64_t *args, int idx) {
    __gm__ TaskTensor *tensor = reinterpret_cast<__gm__ TaskTensor *>(args[idx]);
