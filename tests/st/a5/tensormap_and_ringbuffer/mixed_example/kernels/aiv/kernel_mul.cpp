...
/**
 * Element-wise TaskTensor Multiplication Kernel (for mixed task, AIV1 slot)
 *
...
extern "C" __aicore__ void kernel_entry(__gm__ int64_t *args) {
    __gm__ TaskTensor *src0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[6]);
    __gm__ TaskTensor *src1_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[7]);
    __gm__ TaskTensor *out_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[8]);
